  ...
  <main class="main">
    ...
    <div class="d-flex gap-5">
      ...
      <div class="w-50">
        ...
        >
          <div>
            <p class="m-0 details-heading">入住时间</p>
          ...
          <div>
            <p class="m-0 details-heading">入住人数</p>
            <p class="m-0 details-body">{{ guestData.adult }} 成人</p>
            <p class="m-0 details-body" v-if="guestData.children !== 0">
              {{ guestData.children }} 儿童
            </p>
          </div>
        </div>
        <div
        ...
        <router-link
          ...
          ><button class="book-btn rounded w-100">现在预定</button></router-link
        >
      </div>
    </div>
  </main>

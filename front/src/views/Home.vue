  ...
  <main class="home">
    ...
    <div class="input-container">
      ...
      >
        <div class="guest-input-header">
          <span class="me-2">{{ adultNum }} 成人</span
          ><span class="me-2">-</span
          ><span class="me-2">{{ childrenNum }} 儿童</span
          ><span class="me-2">-</span>
          <span>{{ roomNum }} 房间</span>
        </div>
        <div v-show="isSelectionOpen" class="guest-input-body w-100">
          <div class="d-flex align-items-center w-100 mb-3">
            <span class="w-50">成人</span>
      ...
      <router-link class="search-button" :to="{ name: 'HotelResults' }"
        ><button @click="setGuestData">查询~</button></router-link
      >
    </div>
    ...
    <div class="destination-ideas">
      <div class="destination1">
        <p class="dest-name">北京</p>
      </div>
      <div class="destination2">
        <p class="dest-name">上海</p>
      </div>
      <div class="destination3">
        <p class="dest-name">广州</p>
      </div>
    </div>
  </main>
</template>

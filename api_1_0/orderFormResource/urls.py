...
from api_1_0.orderFormResource.orderFormOtherResource import GetUserOrderFormInfoResource, CancelOrderFormResource
...
api.add_resource(CancelOrderFormResource, '/orderForm/cancel', endpoint='cancel')
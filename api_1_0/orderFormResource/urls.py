...
from api_1_0.orderFormResource.orderFormOtherResource import GetUserOrderFormInfoResource, SubmitOrderFormResource, GetOrderFormListResource
...
api.add_resource(GetOrderFormListResource, '/orderForm/getList', endpoint="getList")